        ...
        <div class="grid lg:grid-cols-3 md:grid-cols-2 items-center gap-4 h-full">
            <div
                ...
                <img src="https://readymadeui.com/signin-image.webp"
                    class="lg:w-[70%] w-full h-full object-contain block mx-auto" alt="login-image" />
            </div>
            ...
            <div class="w-full p-6">
                <form @submit.prevent="handleLogin">
                    <div class="mb-8">
                        ...
                        <p class="text-sm mt-4 text-gray-800">Don't have an account <RouterLink to="/register"
                                class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register
                                here</RouterLink> Or <RouterLink to="/"
                                class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Back
                            </RouterLink>
                        </p>
                    </div>
