...
<template>
    <div class="app-container">
        ...
        <div class="font-[sans-serif] max-w-4xl flex items-center mx-auto md:h-screen p-4">
            <div
                class="grid md:grid-cols-3 bg-white items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-xl overflow-hidden">
                <div
                    ...
                    <div>
                        ...
                        <p class="text-[13px] text-gray-300 mt-3 leading-relaxed">Welcome to our registration page! Get
                            started by creating your account.</p>
                    </div>
                    <div>
                        <h4 class="text-white text-lg font-semibold">Simple & Secure Registration</h4>
                        <p class="text-[13px] text-gray-300 mt-3 leading-relaxed">Our registration process is designed
                            to be
                            straightforward and secure. We prioritize your privacy and data security.</p>
                    </div>
                </div>

                <form @submit.prevent="handleRegister" class="md:col-span-2 w-full py-6 px-6 sm:px-16">
                    <div class="mb-6">
                        ...
                        <div>
                            ...
                            <div class="relative flex items-center">
                                <input name="email" type="email" required
                                    class="text-gray-800 bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded-md outline-blue-500"
                                    v-model="email" placeholder="Enter email" autocomplete="email" />
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb"
                        ...
                        <div>
                            ...
                            <div class="relative flex items-center">
                                <input name="password" type="password" required
                                    class="text-gray-800 bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded-md outline-blue-500"
                                    v-model="password" autocomplete="new-password" placeholder="Enter password" />
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb"
                    ...
                    <p class="text-gray-800 text-sm mt-6 text-center">Already have an account? <RouterLink
                            class="text-blue-600 font-semibold hover:underline ml-1" to="/login">Login
                            here</RouterLink>
                    </p>
                </form>
            </div>
